 ...
 */
contract OwnableERC4626MigratorWithOSQTH is Ownable2Step, ReentrancyGuard {
    ...
    **********/
    ...
    ERC20 public constant OSQTH = ERC20(0xf1B99e3E573A1a9C5E6B2Ce818b617F0E664E86B);
    ...
    uint256 public osqthPerERC4626;
     ...
     */
    function updateRates(uint256 _floatingSupply) external onlyOwner returns (uint256, uint256, uint256, uint256) {
        ...
        osqthPerERC4626 = OSQTH.balanceOf(address(this)).mulDivDown(1e18, _floatingSupply);
        return (wethPerERC4626, daiPerERC4626, usdcPerERC4626, osqthPerERC4626);
    }
     ...
     * @return The amount of osqth sent to the user
     */
    function adminMigrate(uint256 _amount, address _to) external onlyOwner returns (uint256, uint256, uint256, uint256) {
     ...
     * @return The amount of osqth sent to the user
     */
    function _exitFunds(uint256 _amount, address _to, bool _pullFunds) internal returns (uint256, uint256, uint256, uint256) {
        ...
        uint256 osqthToSend = _amount.mulDivDown(osqthPerERC4626, 1e18);
        ...
        if (osqthToSend > 0) OSQTH.safeTransfer(_to, osqthToSend);

        return (wethToSend, daiToSend, usdcToSend, osqthToSend);
    }
}
